...
const SolutionCard = ({
  ...
  return (
    <div className="bg-white dark:bg-primary-dark-gray p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow border-t-4 border-red-600 dark:border-accent_gray">
      <div className="bg-gray-100 dark:bg-gray-800 w-16 h-16 rounded-lg flex items-center justify-center mb-4">
